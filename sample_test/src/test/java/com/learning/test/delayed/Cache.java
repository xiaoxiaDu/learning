...
public class Cache {
    ...
    public DelayQueue<DelayedItem<Object>> queue = new DelayQueue();


    public void put(String key, Object value, long liveTime) {
        Object v2 = map.put(key, value);
        DelayedItem<Object> tmpItem = new DelayedItem(key, liveTime);
        if (v2 != null) {
    ...
    public void dameonCheckOverdueKey() {
        while (true) {
            DelayedItem<Object> delayedItem = queue.poll();
            if (delayedItem != null) {
